import {Meta,ColorPalette,ColorItem, Heading, Subheading, } from '@storybook/addon-docs/blocks'
...
<br/>
<ColorPalette>
  <ColorItem title="single" subtitle='--jb-black,--jb-white,--jb-highlight'  colors={{'black': colors.single.black.value,'white':colors.single.white.value, 'highlight':colors.single.highlight.value}}/>
  <ColorItem title="neutral" subtitle='--jb-neutral,--jb-neutral-[index]' colors={{'main':colors.neutral[0].value,'d1':colors.neutral[1].value,'d2':colors.neutral[2].value,'d3':colors.neutral[3].value,'d4':colors.neutral[4].value,'d5':colors.neutral[5].value,'d6':colors.neutral[6].value,'d7':colors.neutral[7].value,'d8':colors.neutral[8].value,'d9':colors.neutral[9].value,'d10':colors.neutral[10].value}}/>
  <ColorItem title="primary" subtitle="--jb-primary,--jb-primary-[name]" colors={{'main':colors.primary.main.value,'l(lighter)':colors.primary.light.value, "d(dark)":colors.primary.dark.value,'subtle':colors.primary.subtle.value, 'contrast':colors.primary.contrast.value ,'hover':colors.primary.hover.value,'pressed':colors.primary.pressed.value}}/>
  <ColorItem title="secondary" subtitle="--jb-secondary,--jb-secondary-[name]" colors={{'main':colors.secondary.main.value, 'l(lighter)':colors.secondary.light.value, "d(dark)":colors.secondary.dark.value,'subtle':colors.secondary.subtle.value, 'contrast':colors.secondary.contrast.value,'hover':colors.secondary.hover.value,'pressed':colors.secondary.pressed.value}}/>
  <ColorItem title="success" subtitle="--jb-green,--jb-green-[name]" colors={{'main':colors.green.main.value,'l(lighter)':colors.green.light.value, "d(dark)":colors.green.dark.value,'subtle':colors.green.subtle.value, 'contrast':colors.green.contrast.value,'hover':colors.green.hover.value,'pressed':colors.green.pressed.value}}/>
  <ColorItem title="error" subtitle="--jb-red,--jb-red-[name]"  colors={{'main':colors.red.main.value,"l(lighter)":colors.red.light.value, "d(dark)":colors.red.dark.value,'subtle':colors.red.subtle.value, 'contrast':colors.red.contrast.value,'hover':colors.red.hover.value, 'pressed':colors.red.pressed.value}}/>
  <ColorItem title="warning" subtitle="--jb-yellow,--jb-yellow-[name]" colors={{'main':colors.yellow.main.value, 'l(lighter)':colors.yellow.light.value, "d(dark)":colors.yellow.dark.value,'subtle':colors.yellow.subtle.value, 'contrast':colors.yellow.contrast.value,'hover':colors.yellow.hover.value, 'pressed':colors.yellow.pressed.value}}/>
</ColorPalette>

<Subheading>Semantic color tokens</Subheading>

Semantic color tokens describe how a color is used instead of how it looks. Content tokens represent foreground content such as text, icons, and SVG strokes. Components should prefer semantic tokens over primitive tokens such as `--jb-black` or `--jb-neutral-7`. This keeps component styles independent from the primitive palette and makes theme changes easier.

The default semantic tokens are aliases of primitive colors, so changing a primitive also updates every semantic token that references it.
...
<table>
  ...
  <tbody>
    <tr>
      <td><code>--jb-content-primary</code></td>
      <td><code>--jb-black</code></td>
      <td>Primary text, labels, and high-emphasis content</td>
    </tr>
    <tr>
      <td><code>--jb-content-secondary</code></td>
      <td><code>--jb-neutral-7</code></td>
      <td>Supporting text, descriptions, and lower-emphasis content</td>
    </tr>
    <tr>
      <td><code>--jb-content-inverse</code></td>
      <td><code>--jb-white</code></td>
      <td>Text displayed on an inverse or dark surface</td>
    </tr>
    <tr>
      <td><code>--jb-surface-primary</code></td>
      <td><code>--jb-white</code></td>
      <td>Main page and component surfaces</td>
    </tr>
    <tr>
      <td><code>--jb-surface-secondary</code></td>
      <td><code>--jb-neutral-10</code></td>
      <td>Secondary or visually separated surfaces</td>
    </tr>
    <tr>
      <td><code>--jb-surface-inverse</code></td>
      <td><code>--jb-black</code></td>
      <td>Surfaces that invert the default light theme</td>
    </tr>
  </tbody>
</table>
...
To change the palette while preserving the default semantic relationships, override the primitive tokens:
...
You can also remap semantic roles within a specific theme or application section:
...
When adding component variables, keep a component-level override first and a semantic token as its default:
