...
<p>
  ...
  - `getSubtleColor(l:number,c:number,h:number)` will give you a subtle color based on the color you provide. it will return a color that is a more like pastel color for quieter tone.
  - `getContrastColor(l:number,c:number,h:number)` will give you a contrast color based on the color you provide. it will give you a most contrast color based on your background color in light mode it is Dark and in light mode its light.
</p>
<br/>
<p>
